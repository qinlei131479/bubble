...
public class KnowledgeBasesController {
	...
	public R<Page<KnowledgeBases>> page(@ParameterObject Pg pg, @ParameterObject KnowledgeBases req) {
	...
	@GetMapping("/details")
	@HasPermission("agi_knowledgeBases_view")
	public R<List<KnowledgeBases>> details(@ParameterObject KnowledgeBases req) {
