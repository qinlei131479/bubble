...
public class EvaluationResultDetailsController {
	...
	public R<Page<EvaluationResultDetails>> page(@ParameterObject Pg pg, @ParameterObject EvaluationResultDetails req) {
	...
	@GetMapping("/details")
	@HasPermission("agi_evaluationResultDetails_view")
	public R<List<EvaluationResultDetails>> details(@ParameterObject EvaluationResultDetails req) {
