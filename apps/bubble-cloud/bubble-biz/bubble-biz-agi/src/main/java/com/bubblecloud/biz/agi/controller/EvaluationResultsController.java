...
public class EvaluationResultsController {
	...
	public R<Page<EvaluationResults>> page(@ParameterObject Pg pg, @ParameterObject EvaluationResults req) {
	...
	@GetMapping("/details")
	@HasPermission("agi_evaluationResults_view")
	public R<List<EvaluationResults>> details(@ParameterObject EvaluationResults req) {
