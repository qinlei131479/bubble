...
public class KnowledgeFilesController {
	...
	public R<Page<KnowledgeFiles>> page(@ParameterObject Pg pg, @ParameterObject KnowledgeFiles req) {
	...
	@GetMapping("/details")
	@HasPermission("agi_knowledgeFiles_view")
	public R<List<KnowledgeFiles>> details(@ParameterObject KnowledgeFiles req) {
