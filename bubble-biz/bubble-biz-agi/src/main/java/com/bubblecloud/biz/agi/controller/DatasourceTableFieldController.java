...
public class DatasourceTableFieldController {
	...
	public R<Page<DatasourceTableField>> page(@ParameterObject Pg pg, @ParameterObject DatasourceTableField req) {
	...
	@GetMapping("/details")
	@HasPermission("agi_datasourceTableField_view")
	public R<List<DatasourceTableField>> details(@ParameterObject DatasourceTableField req) {
