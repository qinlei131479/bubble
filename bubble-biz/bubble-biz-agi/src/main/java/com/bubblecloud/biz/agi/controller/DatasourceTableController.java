...
public class DatasourceTableController {
	...
	public R<Page<DatasourceTable>> page(@ParameterObject Pg pg, @ParameterObject DatasourceTable req) {
	...
	@GetMapping("/details")
	@HasPermission("agi_datasourceTable_view")
	public R<List<DatasourceTable>> details(@ParameterObject DatasourceTable req) {
