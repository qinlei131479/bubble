...
public class ConversationsController {
	...
	public R<Page<Conversations>> page(@ParameterObject Pg pg, @ParameterObject Conversations req) {
	...
	@GetMapping("/details")
	@HasPermission("agi_conversations_view")
	public R<List<Conversations>> details(@ParameterObject Conversations req) {
