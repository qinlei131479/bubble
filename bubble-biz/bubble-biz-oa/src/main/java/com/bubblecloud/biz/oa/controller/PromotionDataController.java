...
public class PromotionDataController {
	...
	public R<SimplePageVO> page(@ParameterObject Pg pg, @ParameterObject PromotionData query) {
		Page<PromotionData> res = promotionDataService.findPg(pg, query);
	...
	public R<String> create(@RequestBody PromotionDataSaveDTO dto) {
		PromotionData obj = PojoConvertUtil.convertPojo(dto, PromotionData.class);
		promotionDataService.create(obj);
	...
	public R<String> update(@PathVariable Long id, @RequestBody PromotionDataSaveDTO dto) {
		PromotionData obj = PojoConvertUtil.convertPojo(dto, PromotionData.class);
		obj.setId(id);
		promotionDataService.update(obj);
	...
	public R<String> removeById(@PathVariable Long id) {
		promotionDataService.deleteById(id);
	...
	public R<String> updateStandard(@PathVariable Long id, @RequestBody PromotionDataStandardDTO dto) {
		PromotionData obj = PojoConvertUtil.convertPojo(dto, PromotionData.class);
		obj.setId(id);
		promotionDataService.updateStandard(obj);
		return R.phpOk(OaConstants.UPDATE_SUCC);
	}

	@PostMapping("/sort/{pid}")
	@Operation(summary = "数据项排序")
	public R<String> sort(@PathVariable Long pid, @RequestBody PromotionDataStandardDTO dto) {
		PromotionData obj = PojoConvertUtil.convertPojo(dto, PromotionData.class);
		obj.setId(pid);
		promotionDataService.sortPromotionData(obj);
