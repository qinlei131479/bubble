package com.bubblecloud.common.excel;
...
import com.bubblecloud.common.excel.provider.RemoteDictApiService;
import com.bubblecloud.common.excel.provider.RemoteDictDataProvider;
...
public class ExcelAutoConfiguration {
	...
	private String getBaseUrl() {
		...
		if (SpringContextHolder.isMicro()) {
			return String.format("http://%s", ServiceNameConstants.BACKEND_SERVICE);
		}
		else {
